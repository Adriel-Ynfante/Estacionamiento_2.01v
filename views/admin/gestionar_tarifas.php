...
<body>
                        ...
                        <div class="tab-pane fade active in" id="new">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <form id="rateForm" onsubmit="validateForm(event)" action="gestionar_tarifas.php" method="POST">
                                        <div class="form-group label-floating">
                                            <label class="control-label">ID Zona:</label>
                                            <input class="form-control" type="number" name="id_zona" required>
                                        </div>
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label" for="tipo_reserva">Tipo de Reserva:</label>
                                        ...
                                        <p class="text-center">
                                            <button type="submit" class="btn btn-info btn-raised btn-sm">
                                                <i class="zmdi zmdi-floppy"></i> Agregar Zona
                                            </button>
                                        </p>
                                        </form>
                                    </div>
    ...
    <script>
        function validateForm(event) {
            ...
            const idZona = document.querySelector('[name="id_zona"]').value.trim();
            const tipoVehiculo = document.querySelector('[name="tipo_vehiculo"]').value;
            const tipoReserva = document.querySelector('[name="tipo_reserva"]').value;
            const costo = document.querySelector('[name="costo"]').value.trim();

            // Validaciones
            if (!idZona || isNaN(idZona) || parseInt(idZona) <= 0) {
                alert("Error: ID de zona debe ser un número válido y mayor que cero.");
                return;
            }

            if (!tipoVehiculo) {
                alert("Error: Debe seleccionar un tipo de vehículo.");
                return;
            }

            if (!tipoReserva) {
                alert("Error: Debe seleccionar un tipo de reserva.");
                return;
            }

            if (!costo || isNaN(costo) || parseFloat(costo) < 0) {
                alert("Error: Costo debe ser un número positivo.");
                return;
            }
