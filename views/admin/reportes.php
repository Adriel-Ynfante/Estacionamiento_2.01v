...
<body>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="gestionEmpresas.html"><i class="zmdi zmdi-face zmdi-hc-fw"></i> Empresas</a>
						</li>
					</ul>
				</li>
				<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="full-box text-center" style="padding: 30px 10px;">
			<h1>Mapa de Zonas de Estacionamiento</h1>
    <div id="map"></div>
		</div>	
	</section>
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 12,
            center: {lat: -5.1945, lng: -80.6328} // Cambia a la ubicación central deseada
        });

        var zonas = <?php echo json_encode($zonas); ?>; // Pasar datos de PHP a JavaScript
